<?php
    ...
    function wp_word_cloud_get_global_settings() {
        ...
        return [
			'source-type'		=> ['default' => 'inline',              'valid' => ['inline', 'url', 'sql', 'custom-field', 'id'], 'hidden' => false, 'description' => 'Woher kommt die Liste gezählter Wörter? Möglich sind url, inline, sql, post oder page id sowie custom-field'],
